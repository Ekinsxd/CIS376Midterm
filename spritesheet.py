...
sprite1 = [my_spritesheet.parse_sprite('lm1'), 
...
sprite3 = [my_spritesheet.parse_sprite('tm1'),
my_spritesheet.parse_sprite('tm2')]

sprite4  = [my_spritesheet.parse_sprite('fm1'), 
...
sprite5 = [my_spritesheet.parse_sprite('g1'),
my_spritesheet.parse_sprite('g2'),
my_spritesheet.parse_sprite('g3'),
]

sprite6 = [my_spritesheet.parse_sprite('k1'),
...
my_spritesheet2 = Spritesheet("items-objects", "png")
sprite7 = [
...
while 1:
    ...
    canvas.blit(sprite7[i], (0, 600 - 100))
